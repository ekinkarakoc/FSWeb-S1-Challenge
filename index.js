...
function indekseGoreFenomen(dizi, i) {
  let sonuc = `${i}. indekste bulunan fenomen: ${dizi[i].profile}`;
  // let sonuc = i + ". indekste bulunan fenomen: " + dizi[i].profile;
  return sonuc;
}
...
// console.log("orjinali", fenomenler[0]);
// console.log("kopyası", fenomenSil(fenomenler, 0)[0]);
